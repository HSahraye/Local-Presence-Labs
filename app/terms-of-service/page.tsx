...
export const metadata: Metadata = {
  ...
  description: "Terms of service for Presence Labs.",
};
  ...
  return (
    <div className="container-shell py-16">
      ...
      <div className="mt-8 space-y-6 rounded-2xl border border-[#3B82F6]/20 bg-white p-6 text-sm leading-relaxed text-[#334155]">
        <section>
          <h2 className="text-base font-semibold text-[#0F172A]">Website Use</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-base font-semibold text-[#0F172A]">No Guarantees</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-base font-semibold text-[#0F172A]">Intellectual Property</h2>
          <p className="mt-2">
            Unless otherwise stated, all website content is owned by Presence Labs and
