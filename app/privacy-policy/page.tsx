...
export const metadata: Metadata = {
  ...
  description: "Privacy policy for Local Presence Labs.",
};
  ...
  return (
    <div className="container-shell py-16">
      <SectionHeading
        eyebrow="Legal"
        title="Privacy Policy"
        description="Local Presence Labs values your privacy and handles contact information with care."
      />
      <div className="mt-8 space-y-6 rounded-2xl border border-[#1C768F]/20 bg-white p-6 text-sm leading-relaxed text-[#334155]">
        <section>
          <h2 className="text-base font-semibold text-[#032539]">Information We Collect</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-base font-semibold text-[#032539]">How We Use Information</h2>
          <p className="mt-2">
        ...
        <section>
          <h2 className="text-base font-semibold text-[#032539]">Data Sharing</h2>
          <p className="mt-2">
